    ...
    <div className="min-h-screen bg-[var(--bg-primary)] pb-32 overflow-hidden">
      ...
      <main className="pt-20 lg:pt-28 px-6 max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 mb-24">
          {stats.map((stat, i) => (
            <div key={i} className="glass-card p-10 group hover:bg-[var(--bg-secondary)]/[0.6] transition-all duration-[var(--duration-normal)] border-transparent hover:border-[var(--brand-500)]/20">
              ...
              <div className="text-4xl md:text-5xl font-black text-[var(--text-primary)] mb-2 tracking-tighter group-hover:translate-x-1 transition-transform">{stat.value}</div>
        ...
        <section className="space-y-16">
           <div className="flex flex-col md:flex-row items-end justify-between gap-8">
                <div className="space-y-4">
                    ...
                    <h3 className="text-5xl font-black tracking-tight">Radical Impact.</h3>
                </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              {testimonials.map((t, i) => (
                <div key={i} className="glass-card p-12 group hover:bg-[var(--bg-secondary)]/[0.8] transition-all duration-500 relative bg-white/[0.02]">
        ...
        <section className="mt-24 relative group overflow-hidden rounded-[3rem] border border-[var(--border-primary)]">
           ...
           <div className="relative z-10 text-center max-w-3xl mx-auto py-16 px-8 space-y-12">
              ...
              <div className="space-y-6">
                <h2 className="text-4xl md:text-7xl font-black tracking-tighter leading-none">Execute Like the 1%.</h2>
